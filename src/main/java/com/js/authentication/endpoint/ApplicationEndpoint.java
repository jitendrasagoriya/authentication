...
public class ApplicationEndpoint {
    ...
    public ResponseEntity<?> getAuthenticationsForApplication(@PathVariable("appid") String appid, @RequestHeader("X-AUTH-LOG-HEADER") String access, Pageable pageable) {
        try {
